...
### Added
- Integrated the new `SwiftEspeakVoiceProvider`, enabling local eSpeak synthesis through the SwiftEspeak package.

### Documentation
- Documented SwiftEspeak provider usage and requirements in the main README.
