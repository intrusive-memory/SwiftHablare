...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/intrusive-memory/SwiftCompartido.git", from: "7.0.3"),
    .package(url: "https://github.com/intrusive-memory/SwiftProyecto.git", from: "3.2.2"),
