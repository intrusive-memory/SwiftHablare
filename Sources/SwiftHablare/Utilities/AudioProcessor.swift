...
public struct ProcessedAudio: Sendable {
  ...
  public init(
    audioData: Data, durationSeconds: Double, trimmedStart: Double, trimmedEnd: Double,
...
public enum AudioProcessor {
  ...
  public static func process(
    audioData: Data, mimeType: String = "audio/mpeg", threshold: Float = -50.0
  ...
  private static func detectSilence(in asset: AVAsset, threshold: Float) async throws -> (
  ...
  private static func calculateRMS(sampleBuffer: CMSampleBuffer) -> Float {
    ...
    let samples = UnsafeBufferPointer(
      start: data.withMemoryRebound(to: Int16.self, capacity: length / 2) { $0 }, count: length / 2)
  ...
  private static func trimAudio(asset: AVAsset, trimStart: Double, trimEnd: Double) async throws
    -> Data
  {
