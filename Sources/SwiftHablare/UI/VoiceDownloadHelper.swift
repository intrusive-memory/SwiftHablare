  ...
  public enum VoiceDownloadHelper {
    ...
    public enum VoiceDownloadError: LocalizedError {
      ...
      public var errorDescription: String? {
        ...
        case .settingsOpenFailed:
          return
            "Failed to open System Settings. Please open it manually and navigate to Accessibility → Read & Speak → System voice."
        case .userCancelled:
    ...
    public static func promptUserToDownloadPremiumVoices(
      completion: @escaping @Sendable (Result<Bool, VoiceDownloadError>) -> Void
    ) {
